...
public final class AWSMutationCache {
	...
	private let recordIdentifier = Expression<CacheKey>(value: "recordIdentifier")
    private let data = Expression<Data>("data")
	private let recordState = Expression<String>(value: "recordState")
	private let timestamp = Expression<Date>("timestamp")
	private let s3Bucket = Expression<String?>(value: "s3Bucket")
	private let s3Key = Expression<String?>(value: "s3Key")
	private let s3Region = Expression<String?>(value: "s3Region")
	private let s3LocalUri = Expression<String?>(value: "s3LocalUri")
	private let s3MimeType = Expression<String?>(value: "s3MimeType")
	private let operationString = Expression<String>(value: "operationString")
